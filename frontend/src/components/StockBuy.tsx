...
useEffect(()=>{
    ...
    return (
        change ? (<div className="flex px-2   justify-center items-center bg-gray-300 w-full min-h-screen">
            <div className=" flex gap-2 lg:flex-row flex-col max-w-6xl w-full justify-between items-center  mx-auto">
                ...
                <div className="flex flex-col gap-2 ">
                    ...
                    <div className="overflow-y-auto max-h-32 lg:max-h-64 ">
                        {stockRecord[stockSymbol][0]?.slice().map((stock :any) => { return <Price price={stock.price} quantity={stock.quantity} orderType="buy" /> })}
                    </div>
                ...
                <div className=" flex flex-col gap-2 p-4 w-full">
                    ...
                    {placeOrderType=== "limit"?(<div className="flex flex-col gap-2">
                        ...
                        <div className="">
                            ...
                            placeholder="Enter Limit Price " value={price} className="p-3 rounded-xl text-gray-600 border border-gray-400 w-full focus:border-white focus:ring-2 focus:ring-blue-400" type="number" min={0}  ></input>
                        </div>
                    </div>): ""}
                     ...
                     <div className="text-lg font-medium">
                        ...
                        <div className="">
                            ...
                            placeholder="Enter Quantity " value={quantity} className="p-3 rounded-xl text-gray-600 border border-gray-400 w-full focus:border-white focus:ring-2 focus:ring-blue-400" type="number" min={0}  ></input>
                        </div>
                        {placeOrderType=== "market" &&filled?<div className="flex justify-between text-md items-center text-gray-600">
                            <div>
                                * For market order Fetch The price first (or buy directly )
                            </div>
                            <button className="p-2 bg-blue-500 cursor-pointer transition-all duration-300 hover:shadow-blue-500 shadow-md text-white rounded-xl">Fetch Price </button>
                        </div>:""}
                        ...
                        <button className={`rounded-xl w-full ${filled?"bg-[#16A34A]  text-white":" bg-gray-400 text-white"} p-3 my-2  cursor-pointer `}>Place Buy Order </button>
        ...
        </div>) : (loader ? (<div>ok</div>) : <div className="flex flex-col   bg-gray-200 w-full min-h-screen ">
