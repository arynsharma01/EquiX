            ...
            <div className="flex flex-col gap-2 bg-white border border-gray-100 p-5 rounded-2xl ">
                <div className="pt-2 flex flex-col">
                    <input
                        ...
                        onChange={(e) => { getSearchResult(e.target.value) }} type="text" placeholder="Search Stock by Symbol or Company name " />
                    {searched && searchResult ? (<div className="flex flex-col bg-white w-full z-0   "> {searchResult?.map((value) => { 
